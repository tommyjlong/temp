			...
			switch (player->state)
			{
				case RTSP_DESCRIBE:
					...
					if (responseCode==401)
					{
						 ...
						 *   then bail out.
						 */ 
                                                if ((rtsp_auth_fail_count < 3) && (GetAuthSchemeBasic(buffer,bufferLen,&basic_data) == 0) )
                                                {
						     ...
						     */
 						    ...
 						    /*[v3.2] add auth fail counts */ 
                                                    if ((rtsp_auth_fail_count < 5) && (GetAuthSchemeDigest(buffer,bufferLen,&digest_data) == 0) )
                                                    {
